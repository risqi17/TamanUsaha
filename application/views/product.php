                ...
                <div class="col-lg-2 wow fadeIn" data-wow-delay="0.2s">
                    ...
                    <div class="widget-wrapper">
                        <div class="list-group">
                            ...
                            <a href="<?php echo base_url('index.php/product/add_product') ?>" class="list-group-item active">Tambah Produk</a>
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="card wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--Text-->
                                    <form action="<?php echo base_url(); ?>index.php/product/act_add" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="md-form form-sm">
                                                    <input type="text" name="nama" id="form1" class="form-control">
                            ...
                            <div class="card wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="md-form">
                                                <textarea id="textarea-char-counter" class="md-textarea" name="deskripsi" length="500"></textarea>
                                     ...
                                     <div class="row">
                                        <div class="col-md-4">
                                            <div class="md-form form-sm">
                                                <input type="number" id="form1" name="stok" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="md-form form-sm">
                                                <input type="number" id="form1" name="harga" class="form-control">
                                     ...
                                     <div class="row">
                                        <div class="col-md-4">
                                            <div class="md-form form-sm">
                                                <input type="number" id="form1" name="berat" class="form-control">
                           ...
                           <div class="card wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="md-form">
                                                <textarea id="textarea-char-counter" name="DeskripsiTambah" class="md-textarea" length="50"></textarea>
                   ...
                   <div class="row">
                       <div class="col-lg-12 mb-3">
                           <div class="wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <button type="submit" name="submit1" class="btn btn-sm rgba-teal-strong">Simpan & Tambah Produk</button>
